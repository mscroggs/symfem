...
test_elements = {
    ...
    "quadrilateral": {
        ...
        "Scurl": {"equispaced": range(1, 4), "gll": range(1, 3)},
        "Sdiv": {"equispaced": range(1, 4), "gll": range(1, 3)},
    ...
    "hexahedron": {
        ...
        "Scurl": {"equispaced": range(1, 3), "gll": range(1, 3)},
        "Sdiv": {"equispaced": range(1, 3), "gll": range(1, 3)},
